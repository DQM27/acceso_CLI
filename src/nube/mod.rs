...
pub use sincronizacion::{
    ConflictoIngresoActivo, ConflictoMovimientoVisitaActivo, ContextoSincronizacion,
    IngresoProveedorRemoto, IngresoRemoto, ResumenCatalogo, ResumenCatalogoRutas, ResumenDrenado,
    SincronizacionError, cerrar_ingreso_proveedor_remoto, cerrar_ingreso_remoto,
    contar_fallos_permanentes, contratista_activo_en_otro_sitio,
    ...
    gafete_provisional_ocupado_en_otro_dispositivo, recibir_catalogo_del_sitio,
    recibir_catalogo_rutas_del_sitio,
