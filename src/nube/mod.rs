...
pub use sincronizacion::{
    ...
    ContextoSincronizacion, IngresoProveedorRemoto, IngresoRemoto,
    ...
    proveedor_activo_en_otro_sitio, proveedores_con_conflicto_activo,
    recibir_catalogo_del_sitio, recibir_catalogo_rutas_del_sitio,
    recibir_cierres_de_ingresos_propios, recibir_cierres_de_ingresos_propios_proveedor,
    recibir_citas_del_sitio, recibir_devoluciones_propias_gafete_provisional,
    recibir_historial_del_sitio, recibir_historial_ingresos_proveedor_del_sitio,
    ...
    usuario_sigue_activo_remoto, visitante_activo_en_otro_sitio,
    visitantes_con_conflicto_activo,
};
