 ...
 * explícito por encima de `prefers-color-scheme` (mismo mecanismo que usa
 * un artifact, ver `design/brisas.json`); acá sólo faltaba el control para
 * tocarlo desde la UI y guardar la elección.
 *
