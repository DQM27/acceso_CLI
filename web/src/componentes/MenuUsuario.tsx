 ...
 * mismo lenguaje que los ítems de la status bar de VSC (texto normal hasta
 * que se pasa el mouse, ahí aparece el fondo de botón, ver
 * `.barra-estado-boton`). Al hacer click abre un popover con nombre/rol y
 * "Cerrar sesión". Copiado de `desktop/src/componentes/MenuUsuario.tsx`.
 */
