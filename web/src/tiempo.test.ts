...
// y hasta ahora no tenía ningún test propio acá, pese a que el original
// sí cubre justo el caso límite documentado (clamp de fin de mes/año
// bisiesto en fechaHaceMeses). Se arma la fecha con getters LOCALES
// directos (no parseando un string UTC fijo), y se compara contra lo que
// el propio runner calcularía para esa misma fecha local — así el test no
// depende de en qué huso horario corre CI, pero sigue agarrando un bug
// real de padding/orden de campos.
