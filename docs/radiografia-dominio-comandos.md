# Radiografía del dominio — para diseño de `--comandos`
...
referencia para diseñar las escenas y mutaciones de `--comandos` — no
...
Login en `--comandos`: cédula y contraseña se escriben en el mismo input,
