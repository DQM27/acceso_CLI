...
/**
 * Sidebar izquierdo de `Shell` (`App.tsx`) — marca, navegación de secciones,
 * usuario y cerrar sesión. Extraído de `Shell` a propósito: esa función ya
 * hace enrutamiento (`seccion`), orquesta los modales globales de
 * ingreso/salida y registra atajos de teclado — el markup del sidebar
 * (~90 líneas) no le agregaba nada a compartir ese scope, sólo hacía más
 * larga la función que sí necesita seguir creciendo con enrutamiento y
